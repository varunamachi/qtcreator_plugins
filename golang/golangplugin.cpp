...
//    QStringList availablePlatforms() const { return QStringList(); }
    ...
    QSet< Core::Id >availableFeatures( Core::Id /* platform */ ) const {
//        return Core::FeatureSet(Core::Feature(GoLang::Constants::GO_SUPPORT_FEATURE));
        auto featureId =  Core::Id( GoLang::Constants::GO_SUPPORT_FEATURE );
        return QSet< Core::Id >{ featureId };
    }

    QSet< Core::Id >availablePlatforms() const { return QSet< Core::Id >{ }; }
    QString displayNameForPlatform( Core::Id /* platform */) const { return QString(); }
};
